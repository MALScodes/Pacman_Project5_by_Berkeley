...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        # find the position of the nearest ghost
        nearestPOS = min(livingGhostPositionDistributions, 
            key=lambda dist: 
            self.distancer.getDistance(pacmanPosition, dist.argMax())).argMax()

        # choose the action that brings Pacman closest to the nearest ghost
        chosenAction = min(legal, 
            key=lambda action: 
